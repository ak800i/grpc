...
namespace Grpc.Core
{
    ...
    {
        static readonly ILogger Logger = GrpcEnvironment.Logger.ForType<SslServerCredentials>();
        ...
        /* Ovde definitivno nesto treba da se uradi.
         * Pogledati u python izmenama mozda se iskristalise sta treba.
         * Mozda treba da se dodaju polja (mada nisam siguran):
         *      ServerCertificateConfig initial_cert_config,
         *      ServerCertificateConfigFetcher cert_config_fetcher,
         *      bool initial_cert_config_fetched.
         * Verovatno cu skontati sve kada budem skontao kako radi callback, gde treba da ga deklarisem, i kako se koristi.
         */
        ...
        internal override ServerCredentialsSafeHandle ToNativeCredentials()
        {
            ...
            Logger.Debug($"serverCertificateConfigCallbackTag={serverCertificateConfigCallbackTag.ToString("X16")}");
